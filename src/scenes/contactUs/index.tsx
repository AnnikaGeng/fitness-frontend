        ...
        >
            ...
            >
                ...
                <p className="my-5">
                    ...
                    trainers and classes to get you to your ultimate 
                    fitness goals with ease. We provide true care into 
            ...
            >
                ...
                >
                    <form
                        ...
                        onSubmit={onSubmit}
                        method="POST"
                        action="https://formsubmit.co/8466105fe45d7eb5973bb8de4741954c"
                    >
                        <input
                        ...
                        <p className="text-primary-500 mt-1">
                            ...
                            {errors.name.type === "pattern" && "Please enter a valid email"}
                        </p>}
